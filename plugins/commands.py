...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            [
                InlineKeyboardButton('🔰 Share Group 🔰', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ', url='http://t.me/Ar_PrincessBot/?startgroup=true')
            ],[
            InlineKeyboardButton('sᴇᴀʀᴄʜ', switch_inline_query_current_chat=''),
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/+37bSP4Ay01xhYzll')
            ],[
